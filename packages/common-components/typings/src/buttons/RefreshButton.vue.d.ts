...
declare global {
    ...
    type __VLS_GlobalComponents = __VLS_PickNotAny<import('vue').GlobalComponents, {}> &
        __VLS_PickNotAny<import('@vue/runtime-core').GlobalComponents, {}> &
        __VLS_PickNotAny<import('@vue/runtime-dom').GlobalComponents, {}> &
        Pick<typeof import('vue'), 'Transition' | 'TransitionGroup' | 'KeepAlive' | 'Suspense' | 'Teleport'>
    type __VLS_IsAny<T> = 0 extends 1 & T ? true : false
    type __VLS_PickNotAny<A, B> = __VLS_IsAny<A> extends true ? B : A
    const __VLS_intrinsicElements: __VLS_IntrinsicElements
    function __VLS_getVForSourceType(source: number): [number, number, number][]
    function __VLS_getVForSourceType(source: string): [string, number, number][]
    function __VLS_getVForSourceType<T extends any[]>(source: T): [item: T[number], key: number, index: number][]
    ...
    function __VLS_directiveFunction<T>(
        dir: T,
    ): T extends import('vue').ObjectDirective<infer E, infer V> | import('vue').FunctionDirective<infer E, infer V> ? (value: V) => void : T
    function __VLS_withScope<T, K>(ctx: T, scope: K): ctx is T & K
    function __VLS_makeOptional<T>(t: T): {
        [K in keyof T]?: T[K]
    }
    type __VLS_SelfComponent<N, C> = string extends N
        ? {}
        : N extends string
          ? {
                [P in N]: C
        ...
        : N2 extends keyof LocalComponents
          ...
          : N3 extends keyof LocalComponents
            ...
            : N1 extends keyof __VLS_GlobalComponents
              ? N1 extends N0
                  ? Pick<__VLS_GlobalComponents, N0 extends keyof __VLS_GlobalComponents ? N0 : never>
                  : {
    ...
    type __VLS_FillingEventArg_ParametersLength<E extends (...args: any) => any> =
        __VLS_IsAny<Parameters<E>> extends true ? -1 : Parameters<E>['length']
    type __VLS_FillingEventArg<E> = E extends (...args: any) => any
        ? __VLS_FillingEventArg_ParametersLength<E> extends 0
            ? ($event?: undefined) => ReturnType<E>
            : E
        : E
    ...
    function __VLS_elementAsFunctionalComponent<T>(t: T): (
        _: T & Record<string, unknown>,
        ctx?: any,
    ) => {
        __ctx?: {
            attrs?: any
    ...
    function __VLS_pickEvent<E1, E2>(
        emitEvent: E1,
        propEvent: E2,
    ): __VLS_FillingEventArg<__VLS_PickNotAny<__VLS_AsFunctionOrAny<E2>, __VLS_AsFunctionOrAny<E1>>> | undefined
    function __VLS_pickFunctionalComponentCtx<T, K>(
        comp: T,
        compInstance: K,
    ): __VLS_PickNotAny<
...
//# sourceMappingURL=RefreshButton.vue.d.ts.map
